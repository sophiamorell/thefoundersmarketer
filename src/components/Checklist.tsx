...
/**
 * 3 · Do you have the problem? Six checkboxes. Below them one line:
 * `ctaBefore` + the CTA button; once the checked count reaches `threshold`
 * the line becomes `ctaCounted` with {n} replaced. State lives in React only.
 */
